...
<body style="background: #e1e9eb;">
	<form action="<%= basePath %>oldmanList" id="mainForm" method="POST">
		...
		<div class="right">
			<div class="current">
				当前位置：<a href="<%=basePath%>oldmanList" style="color: #6E6E6E;">内容管理</a>
				&gt; 内容列表
			</div>
			<div class="rightCont">
				<p class="g_title fix">
					内容列表 <a class="btn03" href="<%= basePath %>queryAddOldman">新
						增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03"
						href="javascript:deleteBath('<%=basePath%>','${oldman.name}','${oldmanPage.currentPage}');">删
						除</a>
				</p>
				<table class="tab1">
					<tbody>
