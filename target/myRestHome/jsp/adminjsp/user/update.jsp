...
<body style="background: #e1e9eb;">
	<form action="<%=basePath%>updateUser" id="updateForm" method="post">
		<input type="hidden" id="id" name="id" value="${user.id}" /> <input
			type="hidden" id="likeName" name="likeName" value="${user.username }" />
					...
					<tbody>
						<tr>
							...
							<td><input type="text" id="username" name="username"
								class="allInput" value="${userQuery.username }" /></td>
						</tr>
						<tr>
							<td width="90" align="right">密&nbsp;&nbsp;码：</td>
							<td><input type="text" id="password" name="password"
								class="allInput" value="${userQuery.password }" /></td>
						</tr>
						<tr>
							<td width="90" align="right">性&nbsp;&nbsp;别：</td>
							<td><select name="gender">
									<c:choose>
										<c:when test="${userQuery.gender eq '男' }">
						...
						<tr>
							...
							<td><input type="text" id="phone" name="phone"
								class="allInput" value="${userQuery.phone }" /></td>
						</tr>
						<tr>
