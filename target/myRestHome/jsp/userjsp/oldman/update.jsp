...
<body style="background: #e1e9eb;">
	<form action="<%=basePath%>updateOldman" id="updateForm" method="post"
		...
		<input type="hidden" id="id" name="id" value="${oldmanQuery.id}" /> 
		<input type="hidden" id="userId" name="userId" value="${oldmanQuery.userId}" />
		<input type="hidden" id="likeName" name="likeName" value="${oldman.name}" /> 
