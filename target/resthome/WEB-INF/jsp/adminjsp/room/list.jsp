...
<body style="background: #e1e9eb;">
	<form action="${page.url}" id="mainForm" method="get">
		...
		<div class="right">
			<div class="current">
				当前位置：<a href="<%=basePath%>room/list" style="color: #6E6E6E;">内容管理</a>
				&gt; 内容列表
			</div>
			<div class="rightCont">
				<p class="g_title fix">
					内容列表 <a class="btn03" href="<%= basePath %>room/queryBeforeUpdateOrInsert">新
						增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03"
						href="javascript:deleteBath('<%=basePath%>room/deleteBath');">删
						除</a>
				</p>
				<table class="tab1">
					<tbody>
							...
							<tr>
								...
								<c:forEach items="${roomList}" var="room" varStatus="index">
									...
									<td><input type="checkbox" name="checkId"
										...
										<td><a href="<%=basePath%>room/queryBeforeUpdateOrInsert?id=${room.id}">修改</a>&nbsp;&nbsp;&nbsp;
											<a href="<%=basePath%>room/delete?id=${room.id}">删除</a>
										</td>
									</tr>
								</c:forEach>
						</tbody>
